  ...
  return (
    <div className="mb-6 space-y-4">
      ...
      <div className="grid grid-cols-5 gap-2">
        <div className="glass-card rounded-2xl px-2 py-3 text-center flex flex-col items-center">
          <p className="text-2xl font-bold text-cyan-600 dark:text-cyan-400">{mesuresTodayCount}</p>
          <p className="text-[9px] leading-tight text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">Mesures aujourd&apos;hui</p>
          <p className="text-[9px] text-gray-400 dark:text-gray-500">{mesuresTodayCabines} cab.</p>
        </div>
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "today" ? null : "today")} className="glass-card rounded-2xl px-2 py-3 text-center flex flex-col items-center hover:shadow-lg active:scale-95 transition-all">
          <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{totalProjectsToday}</p>
          <p className="text-[9px] leading-tight text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">Montages aujourd&apos;hui</p>
        </button>
        <div className="glass-card rounded-2xl px-2 py-3 text-center flex flex-col items-center">
          <p className="text-2xl font-bold text-violet-600 dark:text-violet-400">{servicesTodayCount}</p>
          <p className="text-[9px] leading-tight text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">Services aujourd&apos;hui</p>
          <p className="text-[9px] text-gray-400 dark:text-gray-500">{servicesTodayCabines} cab.</p>
        </div>
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "week" ? null : "week")} className="glass-card rounded-2xl px-2 py-3 text-center flex flex-col items-center hover:shadow-lg active:scale-95 transition-all">
          <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{totalCabinesWeek}</p>
          <p className="text-[9px] leading-tight text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">Cabines cette semaine</p>
        </button>
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "active" ? null : "active")} className="glass-card rounded-2xl px-2 py-3 text-center flex flex-col items-center hover:shadow-lg active:scale-95 transition-all">
          <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">{busyToday}</p>
          <p className="text-[9px] leading-tight text-gray-500 dark:text-gray-400 mt-1 line-clamp-2">Monteurs actifs</p>
        </button>
      </div>
