  ...
  return (
    <div className="mb-6 space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-6 gap-1.5 sm:gap-3">
        ...
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "today" ? null : "today")} className={`glass-card rounded-2xl p-2 sm:p-4 flex flex-col items-center hover:shadow-lg active:scale-95 transition-all ${showSummaryPanel === "today" ? "ring-2 ring-blue-400" : ""}`}>
        ...
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "week" ? null : "week")} className={`glass-card rounded-2xl p-2 sm:p-4 flex flex-col items-center hover:shadow-lg active:scale-95 transition-all ${showSummaryPanel === "week" ? "ring-2 ring-emerald-400" : ""}`}>
        ...
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "active" ? null : "active")} className={`glass-card rounded-2xl p-2 sm:p-4 flex flex-col items-center hover:shadow-lg active:scale-95 transition-all ${showSummaryPanel === "active" ? "ring-2 ring-amber-400" : ""}`}>
        ...
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "emplacement-cabines" ? null : "emplacement-cabines")} className={`glass-card rounded-2xl p-2 sm:p-4 flex flex-col items-center hover:shadow-lg active:scale-95 transition-all ${showSummaryPanel === "emplacement-cabines" ? "ring-2 ring-sky-400" : ""}`}>
        ...
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "rapports-attente" ? null : "rapports-attente")} className={`glass-card rounded-2xl p-2 sm:p-4 flex flex-col items-center hover:shadow-lg active:scale-95 transition-all ${showSummaryPanel === "rapports-attente" ? "ring-2 ring-orange-400" : ""}`}>
        ...
        <button onClick={() => setShowSummaryPanel(showSummaryPanel === "sav-non-traites" ? null : "sav-non-traites")} className={`glass-card rounded-2xl p-2 sm:p-4 flex flex-col items-center hover:shadow-lg active:scale-95 transition-all ${showSummaryPanel === "sav-non-traites" ? "ring-2 ring-rose-400" : ""}`}>
